...
The focus of this lesson is to expand on the fundamentals of the JavaScript `if` statement. The details of the lesson will be **covered in class**, because this lesson is part of a larger assignment that is worth marks. In preparation for the in-class lesson delivery, you should review the [**reading links**](#reading-links) associated with this lesson.

> ### Automated Tests
> 
> This demo is complete with a set of automated tests to check the correctness of your work. To run the tests, open the `tests` subfolder in the terminal and run the following commands.
> 
> ```ps
> pnpm install
> pnpm test
